...
/**
 * Normalizes state names to match common GeoJSON property formats.
 * This is the core fix for the "map not filling" problem.
 */
export const normalizeStateName = (name: string): string => {
  ...
  // Hard mapping for common variations found in Datameet GeoJSON and datasets
